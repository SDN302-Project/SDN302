...
const CoursePage = () => {
    ...
    const handleNext = () => {
        setCourseIndex(Math.min(courses.length - itemsPerPage, courseIndex + itemsPerPage));
    };

    const renderCourses = () => {
        const visibleCourses = courses.slice(courseIndex, courseIndex + itemsPerPage);
        return (
                        ...
                        <div className="col-md-3" key={course._id}>
                            <Link to={`/course/${course._id}`} className="custom-card-link">
                                <div className="custom-card">
                                    <img
                                        src={course.imageCover ? course.imageCover : fallbackImage}
                                        alt="course"
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-8">
                            ...
                            <p className="hero-subtitle">
                                Nâng cao nhận thức và phục hồi với các khóa học chất lượng từ chuyên gia.
                            </p>
                        </div>
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-8">
                            ...
                            <p className="cta-description">
                                Tham gia ngay hôm nay để nâng cao nhận thức và phát triển bản thân.
                            </p>
                        </div>
