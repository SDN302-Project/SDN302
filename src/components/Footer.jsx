...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    setIsLoggedIn(!!user); // ✅ có user thì đã đăng nhập
  }, []);
          ...
          <div className="row gy-4">
            <div className="col-lg-4 col-md-12">
              <div className="footer-about">
                ...
                <p className="mt-3">
                  Chúng tôi cung cấp các khóa học chất lượng cao và dịch vụ tư
                  vấn chuyên nghiệp để giúp bạn đạt được mục tiêu của mình.
                </p>
                <div className="footer-contact mt-4">
                  <p>
                    <FaPhoneAlt className="me-2" /> +84 123 456 789
                  </p>
                  <p>
                    <FaEnvelope className="me-2" /> contact@subtance.edu.vn
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-2 col-md-4">
              ...
              <ul className="footer-links">
                ...
                <li>
                  <Link to="/booking">Đặt lịch tư vấn uy tín</Link>
                </li>
                <li>
                  <Link to="/test">Bài kiểm tra khảo sát</Link>
                </li>
                <li>
                  <Link to="/blog">Blog chuyên sâu</Link>
                </li>
              </ul>
            </div>
